...
class Jzcy2Adapter(mContext:Context) :ListBaseAdapter<JZListBean.DataBean.FmyListBean>(mContext) {
    override val layoutId: Int
        get() = R.layout.item_jzcy2
    ...
    override fun onBindItemHolder(holder: SuperViewHolder, position: Int) {
        ...
        holder.getView<TextView>(R.id.tv_dj)!!.setText(bean.user_level)
        holder.getView<TextView>(R.id.tv_id)!!.setText(bean.tt_id)
