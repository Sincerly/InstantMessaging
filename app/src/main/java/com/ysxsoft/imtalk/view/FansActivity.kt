 ...
 *on 2019/9/12 0012
 */
class FansActivity : BaseActivity(), SwipeRefreshLayout.OnRefreshListener {
    companion object {
        fun startFansActivity(mContext: Context, uid:String){
            val intent = Intent(mContext, FansActivity::class.java)
